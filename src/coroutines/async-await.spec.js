...
describe('async functions', () => {
	...
	describe('business domain scenarios', () => {
		...
		it('average salary of employees having a certain skill, per each office', (done) => {
			...
			async function getEmployeeCountPerOfficeForSkill(skill) {
				// async function body
			}
		...
		it('find employees unassigned to projects, per country', (done) => {
			...
			async function getUnassignedEmployeesPerCountry() {
				// async function body
			}
		...
		it('certain skills count of employees by nationality', (done) => {
			...
			async function skillsCountByNationality(nationality, chosenSkills) {
				// async function body
			}
		...
		it('certain skills count of employees unassigned to projects, by nationality', (done) => {
			...
			async function getUnassignedEmployeesSkillsCountPerCountry(chosenSkills) {
				// async function body
			}
